...
Alpine.data('spotlight', () => ({
    ...
    async runSearch() {
        ...
        try {
            ...
            // Notes and to-dos are plain rows and come from the server suggest
            // endpoint. Bookmarks are still zero-knowledge — searched here,
            // client-side, over the decrypted manifest while the vault is open.
