  ...
  <div class="mx-auto w-full max-w-4xl">
    ...
    <template v-if="!active">
      ...
      <div v-else class="grid gap-3 sm:grid-cols-2">
        <button
          ...
          @click="openShare(sh)"
        >
          <span class="grid h-11 w-11 shrink-0 place-items-center rounded-lg" :style="{ backgroundColor: `${FOLDER_TINT}1a`, color: FOLDER_TINT }">
            <Icon name="folder_shared" :size="24" />
          </span>
          <div class="min-w-0 flex-1">
            <div class="truncate text-sm font-medium">{{ sh.folder_name }}</div>
    ...
    <template v-else>
      <div class="mb-4 flex flex-wrap items-center gap-2">
        ...
        <div v-if="active.role === 'editor'" class="ml-auto">
