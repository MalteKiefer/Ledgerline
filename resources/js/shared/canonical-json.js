...
//   - Strings emitted as-is, no Unicode normalization (spec §5.2 byte-stability):
//     minimal JSON escaping, UTF-8; combining sequences survive verbatim.
...
function encodeString(s) {
    // No Unicode normalization (spec §5.2 byte-stability) — strings are emitted
    // as-is so combining sequences survive verbatim and match Go/Swift/Kotlin.
    // JSON.stringify emits exactly the minimal escape set (", \, and control
    // chars as \uXXXX / \n\r\t\b\f) and leaves all other UTF-8 code points literal
