...
// Material Symbols Outlined ligature per category (Material Design UI). Folders
// use FOLDER_MSYM. Keep in sync with CATEGORY_ICON / CATEGORY_TINT.
export const CATEGORY_MSYM = {
...
export const FOLDER_MSYM = 'folder';

export function categoryMsym(name, mime) {
    return CATEGORY_MSYM[fileCategory(name, mime)] ?? CATEGORY_MSYM.OTHER;
}
