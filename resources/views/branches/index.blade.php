<x-layouts.app title="Branches">
    ...
    <div class="mt-4">
        <x-table-search placeholder="Search branches…" />
    </div>

    <div class="mt-4 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm">
        @if ($branches->isEmpty())
            <p class="px-4 py-8 text-center text-sm text-gray-500">No branches found.</p>
        @else
            <table class="min-w-full divide-y divide-gray-200 text-sm">
                <thead class="bg-gray-50 text-left text-xs font-medium uppercase tracking-wider text-gray-500">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3"><x-sortable-header column="country" label="Country" :sort="$sort" :dir="$dir" /></th>
