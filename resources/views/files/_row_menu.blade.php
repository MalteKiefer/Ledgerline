...
@php $c = 'flex w-full items-center gap-2 px-3 py-1.5 text-left text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800'; @endphp
...
<button type="button" x-show="view === 'files'" @click="openShare(row); menu = false" class="{{ $c }}"><x-icon name="share" />{{ __('files.share') }}</button>
