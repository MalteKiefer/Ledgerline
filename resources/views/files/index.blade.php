            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <template x-if="view === 'files'">
                    <label title="{{ __('files.upload_folder') }}" aria-label="{{ __('files.upload_folder') }}"
                        class="cursor-pointer rounded-xl p-2 text-gray-500 hover:bg-black/[0.04] dark:hover:bg-white/10">
                ...
                <div class="min-h-0 flex-1 overflow-auto p-4">
                    ...
                    <div x-show="viewer.kind === 'text'" x-cloak>
                        <textarea x-model="editorText" spellcheck="false"
                            class="h-[60vh] w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-[#1c1c1e] p-3 font-mono text-sm leading-relaxed text-gray-900 dark:text-gray-100 focus:border-accent focus:ring-accent"></textarea>
