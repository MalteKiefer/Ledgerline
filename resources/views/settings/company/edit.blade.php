<x-layouts.app :title="__('settings.company_title')">
    @php
        $input = 'mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-gray-500 focus:ring-gray-500 sm:text-sm';
    @endphp

    <p class="text-sm text-gray-500">
        <a href="{{ route('settings') }}" class="hover:underline">{{ __('settings.breadcrumb_settings') }}</a> <span aria-hidden="true">/</span> {{ __('settings.breadcrumb_company') }}
    </p>
    <h1 class="mt-1 text-2xl font-semibold text-gray-900">{{ __('settings.company_heading') }}</h1>
    <p class="mt-1 text-sm text-gray-600">{{ __('settings.company_subheading') }}</p>
    ...
    <form method="POST" action="{{ route('settings.company.update') }}" enctype="multipart/form-data" class="mt-6 space-y-8">
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <h2 class="text-sm font-semibold text-gray-900">{{ __('settings.section_company') }}</h2>
            <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    <label for="legal_name" class="block text-sm font-medium text-gray-700">{{ __('settings.legal_name') }}<span class="text-red-600"> *</span></label>
                ...
                <div>
                    <label for="managing_director" class="block text-sm font-medium text-gray-700">{{ __('settings.managing_director') }}</label>
                ...
                <div>
                    <label for="vat_id" class="block text-sm font-medium text-gray-700">{{ __('settings.vat_id') }}</label>
                ...
                <div>
                    <label for="register_court" class="block text-sm font-medium text-gray-700">{{ __('settings.register_court') }}</label>
                    <input type="text" id="register_court" name="register_court" value="{{ old('register_court', $company->register_court) }}" class="{{ $input }}">
                </div>
                <div>
                    <label for="register_number" class="block text-sm font-medium text-gray-700">{{ __('settings.register_number') }}</label>
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <h2 class="text-sm font-semibold text-gray-900">{{ __('settings.section_address') }}</h2>
            <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    <label for="address_line1" class="block text-sm font-medium text-gray-700">{{ __('settings.address_line1') }}</label>
                    <input type="text" id="address_line1" name="address_line1" value="{{ old('address_line1', $company->address_line1) }}" class="{{ $input }}">
                </div>
                <div class="sm:col-span-2">
                    <label for="address_line2" class="block text-sm font-medium text-gray-700">{{ __('settings.address_line2') }}</label>
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <h2 class="text-sm font-semibold text-gray-900">{{ __('settings.section_contact_bank') }}</h2>
            <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                ...
                <div>
                    <label for="bic" class="block text-sm font-medium text-gray-700">{{ __('settings.bic') }}</label>
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <h2 class="text-sm font-semibold text-gray-900">{{ __('settings.section_logo') }}</h2>
            <div class="mt-3 flex items-center gap-4">
                @if ($company->logo_path)
                    <img src="{{ route('settings.company.logo') }}" alt="{{ __('settings.company_logo_alt') }}" class="h-16 w-auto rounded border border-gray-200 bg-white object-contain">
                @endif
        ...
        <section class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
            <h2 class="text-sm font-semibold text-gray-900">{{ __('settings.section_invoice_defaults') }}</h2>
            <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                    <label for="default_language" class="block text-sm font-medium text-gray-700">{{ __('settings.default_language') }}</label>
                ...
                <div>
                    <label for="default_currency" class="block text-sm font-medium text-gray-700">{{ __('settings.default_currency') }}</label>
                ...
                <div>
                    <label for="default_tax_rate" class="block text-sm font-medium text-gray-700">{{ __('settings.default_tax_rate') }}</label>
                ...
                <div>
                    <label for="payment_terms_days" class="block text-sm font-medium text-gray-700">{{ __('settings.payment_terms_days') }}</label>
                ...
                <div>
                    <label for="tax_display" class="block text-sm font-medium text-gray-700">{{ __('settings.tax_display') }}</label>
                    <select id="tax_display" name="tax_display" class="{{ $input }}">
                        <option value="line" @selected(old('tax_display', $company->tax_display ?? 'line') === 'line')>{{ __('settings.tax_display_line') }}</option>
                        <option value="invoice" @selected(old('tax_display', $company->tax_display ?? 'line') === 'invoice')>{{ __('settings.tax_display_invoice') }}</option>
                    </select>
                </div>
                <div>
                    <label for="paper_size" class="block text-sm font-medium text-gray-700">{{ __('settings.paper_size') }}</label>
