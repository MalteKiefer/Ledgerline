<x-layouts.app :title="__('settings.mail_heading')">
    ...
    <h1 class="mt-1 text-2xl font-semibold text-gray-900">{{ __('settings.mail_heading') }}</h1>
        ...
        <template x-if="state === 'ready'">
          <div>
            <div class="flex items-center justify-between gap-3">
                <h2 class="text-sm font-semibold text-gray-900">{{ __('settings.mail_accounts_heading') }}</h2>
            ...
            <template x-if="manifest.accounts.length === 0">
                <p class="mt-4 rounded-lg border border-gray-200 bg-white px-4 py-10 text-center text-sm text-gray-500 shadow-sm">{{ __('mail.empty') }}</p>
            </template>
                ...
                <template x-for="a in sortedAccounts" :key="a.id">
                    <div class="rounded-lg border border-gray-200 bg-white p-5 shadow-sm" x-data="{ menu: false, open: false }">
                        <div class="flex items-start justify-between gap-2">
                            <div class="min-w-0">
                                <h3 class="truncate text-base font-semibold text-gray-900" x-text="a.name"></h3>
