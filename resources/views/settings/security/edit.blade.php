        ...
        <div class="ll-card">
            ...
            <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <label class="text-sm text-gray-700 dark:text-gray-300">{{ __('settings.security_remember_days') }}
                    <input type="number" name="vault_remember_days" value="{{ old('vault_remember_days', $rememberDays) }}" min="1" max="365" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 text-sm shadow-sm focus:border-accent focus:ring-accent">
                ...
                <label class="text-sm text-gray-700 dark:text-gray-300">{{ __('settings.security_idle_minutes') }}
                    <input type="number" name="vault_public_idle_minutes" value="{{ old('vault_public_idle_minutes', $idleMinutes) }}" min="1" max="1440" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 text-sm shadow-sm focus:border-accent focus:ring-accent">
        ...
        <div class="ll-card">
            ...
            <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <label class="text-sm text-gray-700 dark:text-gray-300">{{ __('settings.security_max_devices') }}
                    <input type="number" name="max_connected_devices" value="{{ old('max_connected_devices', $maxDevices) }}" min="1" max="100" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 text-sm shadow-sm focus:border-accent focus:ring-accent">
