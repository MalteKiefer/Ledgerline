<x-layouts.app :title="__('passwords.title')">
  <div x-data="passwords({
        ...
        types: {
            ...
            identity: @js(__('passwords.type_identity')), secure_note: @js(__('passwords.type_secure_note')),
        },
        ...
        fields: {
            ...
            firstName: @js(__('passwords.f_firstName')), lastName: @js(__('passwords.f_lastName')), phone: @js(__('passwords.f_phone')),
            company: @js(__('passwords.f_company')), street: @js(__('passwords.f_street')), city: @js(__('passwords.f_city')),
            state: @js(__('passwords.f_state')), zip: @js(__('passwords.f_zip')), country: @js(__('passwords.f_country')),
        },
      ...
      <div>
        ...
        <template x-if="managingVaultId !== null">
          <div class="fixed inset-0 z-40 flex items-center justify-center bg-black/50 p-4" @keydown.escape.window="managingVaultId = null">
            <div class="w-full w-[50vw] max-w-[50vw] rounded-2xl border border-black/[0.06] dark:border-white/10 bg-white dark:bg-[#1c1c1e] shadow-xl">
