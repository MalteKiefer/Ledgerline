                    ...
                    <template x-for="c in otherCalendars()" :key="c.id">
                        <li class="group flex items-center justify-between gap-1">
                            ...
                            <span class="flex shrink-0 items-center gap-1">
                                <button @click="editCalendar(c)" class="inline-flex md:hidden text-gray-400 hover:text-gray-700 md:group-hover:inline-flex" title="{{ __('calendar.ui.color') }}"><x-icon name="pencil" class="h-4 w-4" /></button>
