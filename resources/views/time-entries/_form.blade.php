...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <div>
        <label for="date" class="block text-sm font-medium text-gray-700">{{ __('timeentries.form.date') }}<span class="text-red-600"> *</span></label>
    ...
    <div>
        <label class="inline-flex items-center gap-2 pt-6 text-sm text-gray-700">
            ...
            {{ __('timeentries.form.billable') }}
        </label>
    </div>

    <div class="sm:col-span-2">
        <label for="description" class="block text-sm font-medium text-gray-700">{{ __('timeentries.form.description') }}<span class="text-red-600"> *</span></label>
    ...
    <div>
        <label for="hours" class="block text-sm font-medium text-gray-700">{{ __('timeentries.form.hours') }}<span class="text-red-600"> *</span></label>
    ...
    <div class="grid grid-cols-2 gap-2">
        <div>
            <label for="rate" class="block text-sm font-medium text-gray-700">{{ __('timeentries.form.rate') }}</label>
            <input type="number" step="0.01" min="0" id="rate" name="rate" value="{{ $rate }}" placeholder="{{ __('timeentries.form.rate_placeholder') }}" class="{{ $input }}">
            <p class="mt-1 text-xs text-gray-400">{{ __('timeentries.form.rate_help') }}</p>
        </div>
        <div>
            <label for="currency" class="block text-sm font-medium text-gray-700">{{ __('timeentries.form.currency') }}</label>
    ...
    <div>
        <label for="customer_id" class="block text-sm font-medium text-gray-700">{{ __('timeentries.form.customer') }}</label>
    ...
    <div>
        <label for="project_id" class="block text-sm font-medium text-gray-700">{{ __('timeentries.form.project') }}</label>
