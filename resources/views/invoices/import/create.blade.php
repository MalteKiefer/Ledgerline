<x-layouts.app :title="__('invoices.import.create.title')">
    <x-finance-nav />
    <p class="text-sm text-gray-500"><a href="{{ route('finance.invoices.index') }}" class="hover:underline">{{ __('invoices.import.create.breadcrumb') }}</a></p>
    <h1 class="mt-1 text-2xl font-semibold text-gray-900">{{ __('invoices.import.create.heading') }}</h1>
    <p class="mt-1 text-sm text-gray-600">{{ __('invoices.import.create.subtitle') }}</p>
