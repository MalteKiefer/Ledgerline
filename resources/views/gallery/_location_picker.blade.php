    ...
    <template x-teleport="body">
        <div x-show="open" x-cloak class="fixed inset-0 z-[1200] flex items-center justify-center p-4" role="dialog" aria-modal="true" @keydown.escape.window="close()">
            ...
            <div class="relative w-full max-w-2xl rounded-lg bg-white p-4 shadow-xl">
                ...
                <div x-ref="pickerMap" class="mt-3 h-80 w-full overflow-hidden rounded-md border border-gray-200"></div>
                ...
                <div class="mt-4 flex justify-end gap-3">
                    <button type="button" @click="close()" class="rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50">{{ __('common.cancel') }}</button>
