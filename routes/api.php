...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['auth:sanctum', 'abilities:device', UpdateTokenIp::class])->group(function (): void {
        ...
        Route::get('/mail/messages', [MailMessageController::class, 'index'])->middleware(['throttle:1200,1', 'module:mail'])->name('api.mail.messages.index');
        Route::get('/mail/accounts/{account}/logs', [MailLogController::class, 'index'])->middleware(['throttle:600,1', 'module:mail'])->name('api.mail.accounts.logs');
