...
class TwoFactorApiTest extends TestCase
{
    ...
    public function test_recovery_codes_available_after_confirmation(): void
    {
        ...
        $response = $this->withToken($token)
            ->json('POST', '/api/v1/user/two-factor/recovery-codes', ['current_password' => 'password'])
            ->assertOk();
    ...
    public function test_recovery_codes_read_requires_the_current_password(): void
    {
        ...
        $this->withToken($token)
            ->json('POST', '/api/v1/user/two-factor/recovery-codes', ['current_password' => 'wrong'])
    ...
    public function test_native_device_token_still_requires_password_to_read_recovery_codes(): void
    {
        ...
        $this->withToken($token)->postJson('/api/v1/user/two-factor/recovery-codes')
            ->assertUnprocessable()->assertJsonValidationErrors(['current_password']);
    ...
    public function test_all_endpoints_require_bearer_token(): void
    {
        ...
        $this->postJson('/api/v1/user/two-factor/recovery-codes')->assertUnauthorized();
