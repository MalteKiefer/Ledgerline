 ...
 * NEVER hard-deleted: "trash" only stamps trashed_at (hides the message from the
 * default list); "restore" clears it. There is deliberately no endpoint that
 * removes a message row or its raw blob — the only true deletion is a full GDPR
 * user-account purge. Both actions are bulk + owner-scoped.
 */
