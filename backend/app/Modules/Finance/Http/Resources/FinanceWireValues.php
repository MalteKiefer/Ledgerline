...
/**
 * Shared with Http\Resources\Quotes\QuoteWireValues: every exact minor-unit
 * or basis-point integer must cross the wire as a string so a JS client
 * cannot silently round it through float parsing.
 */
final class FinanceWireValues
{
    /**
