...
/** @mixin InvoicePage */
final class InvoicePageResource extends JsonResource
{
    public function __construct(private readonly InvoicePage $page)
    {
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'data' => array_map(
                static fn ($invoice): array => (new InvoiceResource($invoice))->resolve($request),
                $this->page->items,
            ),
            'links' => [
