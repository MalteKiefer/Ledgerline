...
/** @mixin RecurringRunPage */
final class RecurringInvoiceRunPageResource extends JsonResource
{
    public function __construct(private readonly RecurringRunPage $page)
    {
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'data' => array_map(
                static fn ($run): array => (new RecurringInvoiceRunResource($run))->resolve($request),
                $this->page->items,
            ),
            'links' => [
