...
return [
    ...
    'pref_mail_avatars' => 'Sender pictures',
    'pref_mail_avatars_hint' => 'Address book only sends nothing. Company logo also looks up the DOMAIN of the sender — via BIMI, the standard by which a company publishes a logo for mail, then favicons. Gravatar-style services are not used: they are keyed by a hash of the address, so asking them announces that this mailbox is being read.',
    'mail_avatars_off' => 'Initials only',
    'mail_avatars_contacts' => 'From my address book',
    'mail_avatars_domain' => 'Also the company logo of the domain',
    ...
    'mail_signatures_title' => 'Mail signatures',
    'mail_signatures_hint' => 'Create reusable signatures, assign them to mailboxes and choose one default per mailbox.',
    'mail_signature_add' => 'Add signature',
    'mail_signature_name' => 'Name',
    'mail_signature_placeholder' => 'Name, role, phone, website …',
    'mail_signature_accounts' => 'Available for these mailboxes',
    'mail_signature_no_accounts' => 'Add a mail account first.',
    'mail_signature_default' => 'Default',
    'mail_signature_empty' => 'Select a signature or create one.',
    'mail_signature_toolbar' => 'Signature formatting',
    'mail_signature_format' => 'Text format',
    'mail_signature_text' => 'Text',
    'mail_signature_heading' => 'Heading',
    'mail_signature_bold' => 'Bold',
    'mail_signature_italic' => 'Italic',
    'mail_signature_underline' => 'Underline',
    'mail_signature_bullets' => 'Bulleted list',
    'mail_signature_numbers' => 'Numbered list',
    'mail_signature_color' => 'Text colour',
    'mail_signature_link' => 'Add link',
    'mail_signature_image' => 'Add image URL',
    'mail_signature_clear' => 'Clear formatting',
