...
return [
    ...
    'exiftool_path_hint' => 'Binary for HEIC / Live Photo metadata.',
    'ml_heading' => 'ML & face recognition',
    'ml_hint' => 'Requires the ML sidecar. Leave a field on default/empty to use the built-in value.',
    'ml_enabled' => 'Image ML (CLIP / duplicates)',
    'face_enabled' => 'Face recognition (People)',
    'ml_default' => 'Default',
    'ml_on' => 'On',
    'ml_off' => 'Off',
    'ml_advanced' => 'Advanced',
    'ml_url' => 'ML service URL',
    'ml_clip_model' => 'CLIP model',
    'face_model' => 'Face model',
    'duplicate_threshold' => 'Duplicate similarity (0–1)',
    'phash_max_distance' => 'pHash max distance',
    'face_min_score' => 'Face min score (0–1)',
    'face_min_size' => 'Face min size (px)',
    'face_cluster_threshold' => 'Face cluster similarity (0–1)',
    'face_min_per_person' => 'Min faces per person',
    'geocode_interval_ms' => 'Geocode interval (ms)',
    ...
    'files_reindex_queued' => 'Re-indexing files for full-text search…',
    'files_reindex_heading' => 'Full-text search index',
    'files_reindex_hint' => 'Re-extract text (OCR) from all files, e.g. after adding files that predate search.',
    'files_reindex_action' => 'Re-index files',
    'calendar_refresh_heading' => 'Subscribed calendars',
    'calendar_refresh_hint' => 'Refresh all subscribed ICS calendars now instead of waiting for the periodic sync.',
    'calendar_refresh_action' => 'Refresh subscriptions',
