...
return [
    ...
    'tx_purpose' => 'Purpose',
    'bank_connect' => 'Connect a bank',
    'bank_sync' => 'Sync',
    'bank_finalize' => 'Finalise',
    'bank_not_configured' => 'Bank retrieval is not configured. An admin must set the GoCardless credentials in the settings.',
    'bank_connect_hint' => 'You will be sent to your bank to authorise access, then returned here. Then press Finalise, then Sync.',
    'bank_synced' => 'Imported :n transaction(s).',
    'bank_no_account' => 'No account link',
