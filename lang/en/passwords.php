...
return [
    ...
    'reset_warning' => 'This permanently deletes ALL your personal password items and vaults, then creates one fresh empty vault. This cannot be undone — export first if you want a backup.',
    'reset_shared_note' => 'Shared vaults are not affected — leave or delete those separately.',
