...
return [
    ...
    'extract_hint' => 'Extrahiert Text aus Dokumenten (PDF, Textdateien) und per OCR aus Scans/Bildern, damit die Suche Wörter darin findet. Bilddateien werden zusätzlich für die semantische Suche eingebettet (ein Bild nach Inhalt finden). Läuft komplett im Browser; nichts wird unverschlüsselt gesendet. OCR ist langsam — Tab offen lassen.',
