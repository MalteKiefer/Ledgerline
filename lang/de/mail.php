...
return [
    ...
    'reindex_hint' => 'Volltext-Index fehlt für :n Nachricht(en).',
    'reindex_build' => 'Index aufbauen',
    'reindex_done' => ':n Nachricht(en) indexiert.',
    'spam' => 'Spam',
    ...
    'delete_origin_confirm' => 'Ausgewählte Nachrichten vom ORIGINAL-Server löschen? Das ist endgültig und kann nicht rückgängig gemacht werden. Deine archivierten Kopien bleiben erhalten.',
    'delete_origin_bulk_done' => 'Vom Server gelöscht: :n (:s übersprungen)',
    'delete_origin' => 'Vom Server löschen',
    ...
    'sync_interval' => 'Abrufintervall (Minuten)',
    'sync_interval_default' => 'Standard',
    'sync_interval_hint' => 'Wie oft dieses Postfach abgerufen wird. Leer lassen für den Workspace-Standard.',
    'mark_read' => 'Als gelesen',
    'mark_unread' => 'Als ungelesen',
    'seen_failed' => 'Lesestatus konnte nicht geändert werden.',
    'unread_count' => ':n ungelesen',
    ...
    'logs_empty' => 'Noch keine Einträge. Synchronisiere, um die Aktivität pro Ordner zu sehen.',
    ...
    'delete_after_import_warn' => 'Jede neu archivierte Nachricht wird endgültig vom Ursprungs-Server gelöscht. Das kann nicht rückgängig gemacht werden.',
