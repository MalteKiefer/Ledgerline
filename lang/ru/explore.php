...
return [
    ...
    'calories' => 'Калории (оценка)',
    'same_route' => 'Тот же маршрут',
    'cmp_when' => 'Когда',
    'cmp_time' => 'Время',
    'cmp_speed' => 'Ср. скорость',
    'cmp_calories' => 'Калории',
    'cmp_fastest' => 'быстрейшая',
    ...
    'no_coupled_photos' => 'Фото ещё не привязаны. Нажмите «Добавить фото», чтобы прикрепить.',
    'add_photos' => 'Добавить фото',
    'search_photos' => 'Поиск фото…',
    'no_photos' => 'В вашей галерее нет фото.',
    'done' => 'Готово',
