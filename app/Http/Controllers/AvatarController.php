 ...
 * remove (destroy). The avatar is a non-secret profile image; it is re-encoded
 * server-side to a square JPEG (stripping any metadata / active payload) before
 * it is stored, and served with a script-less sandbox CSP.
 */
