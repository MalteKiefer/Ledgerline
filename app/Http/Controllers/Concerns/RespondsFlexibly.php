...
trait RespondsFlexibly
{
     ...
     */
    protected function flexible(Request $request, array $json = [], ?string $flashKey = null, ?string $back = null): Response
    {
        ...
        return $flashKey !== null ? $redirect->with('status', __($flashKey)) : $redirect;
    }
}
