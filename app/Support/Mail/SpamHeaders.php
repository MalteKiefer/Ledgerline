...
/**
 * Server-side spam detection from RFC822 headers — a faithful port of the
 * client `shared/mime.js isSpam()`, so the ingest-time filter and the reading
 * UI agree on what "spam" means. Reads only the standard spam-marker headers a
 * receiving mail server stamps (SpamAssassin / Rspamd / generic X-Spam-*).
